...
class NebBlock(OrcaBlock):
    ...
    reparam: int = 0
    tol_turn_on_ci: float = 0.02
    tol_rmsfp_i: float = 0.003
    free_end_ec: float = 0.0
    springconst2: float = 0.1
    convtype: str = "CIONLY"
    tangent: str = "IMPROVED"
    printlevel: int = 4
    zoom_interpolation: str = "LINEAR"
    tol_maxf_ci: float = 0.0005
    neb_ts: bool = False
    quatern: str = "ALWAYS"
    tol_reparam: float = 0.0
    zoom_alpha: float = 0.5
    interpolation: str = "IDPP"
    zoom_auto: bool = True
    zoom_printfulltrj: bool = True
