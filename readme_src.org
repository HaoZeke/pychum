...
** Ecosystem Overview
   ~pychum~ is part of the ~rgpkgs~ suite (hub: ~rgpycrumbs~).

- CON/convel: [[https://github.com/lode-org/readcon-core][readcon-core]] (PyPI: ~readcon~)
- Hub: [[https://github.com/HaoZeke/rgpycrumbs][rgpycrumbs]] · parse/plot: [[https://github.com/HaoZeke/chemparseplot][chemparseplot]] · engine: [[https://eondocs.org][eOn]]
